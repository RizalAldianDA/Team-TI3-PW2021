            ...
            <ul class="navbar-nav" >
                ...
                <li class="dropdown nav-item ">
                    ...
                    <ul class="isi-dropdown">
                        <li><a href="foodrecipes.html">Foods</a></li>
                        <li><a href="snackrecipes.html">Snacks</a></li>
                        <li><a href="drinkrecipes.html">Drinks</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: #cccccc" href="about.html">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: #cccccc" href="contact.html">Contact</a>
                </li>
            </ul>
        </div>
</nav>
...
<div class="container" style="display: flex;">  
        ...
        <div class="col-md-4"> 
            <div class="card mb-4 box-shadow bg-dark"> 
                <img class="card-img-top"  onclick="window.location.href='dawetireng.html'" src="assets/images/dawet.jpg" alt="Card image cap"> 
                <div class="card-body" >
                    <h3 class="content-subhead " >
                        <a href="dawetireng.html" style="color: #ff9933;">Dawet Ireng</a>
                    </h3>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <div class="d-flex justify-content-between align-items-center"> 
                        <div class="btn-group"> 
                        
                        <button type="button" onclick="window.location.href='dawetireng.html'" class="btn btn-sm btn-outline-secondary"  >View</button> 
                        </div> 
